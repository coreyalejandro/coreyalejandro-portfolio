# Corey Anthropic Portfolio App

A modular Next.js App Router + TypeScript portfolio refactor designed to serve as strong signals for both Anthropic Safety and Anthropic Societal Impacts reviewers.
...
1. **Anthropic Safety** — runtime verification, contract-state systems, safety evals, red-team/blue-team discipline, tests.
2. **Anthropic Societal Impacts** — behavioral observability, high-reliance users, agency erosion, differential harm, privacy-aware measurement.
...
- The Agent Sentinel demo is a deterministic portfolio demo, not the full production tool.
