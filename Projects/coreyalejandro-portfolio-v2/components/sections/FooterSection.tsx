    ...
    <footer className="border-t border-border bg-card/40 py-10">
      <div className="container-shell flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
        ...
        <div className="flex flex-wrap gap-3 text-sm text-muted-foreground">
          <a className="inline-flex items-center gap-2 hover:text-foreground" href="https://github.com/coreyalejandro" target="_blank" rel="noopener noreferrer"><Code className="h-4 w-4" /> GitHub</a>
          ...
          <a className="inline-flex items-center gap-2 hover:text-foreground" href="https://agent-sentinel-alignment-anomaly-de.vercel.app" target="_blank" rel="noopener noreferrer"><ExternalLink className="h-4 w-4" /> Agent Sentinel</a>
        </div>
      </div>
    </footer>
  );
