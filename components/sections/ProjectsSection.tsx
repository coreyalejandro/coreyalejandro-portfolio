    ...
    <section id="projects" className="section-pad">
      <div className="container-shell">
        <SectionHeader
          ...
          title="Four artifacts that prove the build."
          description="The featured work mirrors the Anthropic-specific resume: every card states what was engineered, what evidence exists, and why it matters to Safety or Societal Impacts."
        />
            ...
            return (
              <Card key={project.title} className="p-6">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <Button asChild variant="outline" size="sm"><a href={project.repo} target="_blank" rel="noreferrer"><Github className="h-4 w-4" /> Repo</a></Button>
                  <Button asChild variant="secondary" size="sm"><a href={project.live} target={project.live.startsWith("#") ? undefined : "_blank"} rel="noreferrer"><ExternalLink className="h-4 w-4" /> Demo / evidence</a></Button>
                </div>
              </Card>
            );
          })}
