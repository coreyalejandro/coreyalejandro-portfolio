...
export const projects = [
  {
    ...
    track: "Societal Impacts lead artifact",
    status: "Implemented",
    statusTone: "implemented" as const,
    icon: Activity,
    summary:
      "A diagnostic platform that turns agentic interaction logs into structured anomaly signals across long-running AI workflows.",
    bullets: [
    ...
    proof: ["17 anomaly categories", "local log ingestion", "JSON audit export", "risk topology"]
  },
  {
  ...
  },
  {
    ...
    live: "#demo",
    track: "Differential harm artifact",
  ...
  },
  {
    ...
    track: "Platform engineering artifact",
    status: "Implemented",
    statusTone: "implemented" as const,
    icon: Layers3,
    summary:
...
export const researchTracks = [
  {
    ...
    label: "Project idea 01",
    text:
      "Extend session instrumentation to tag position revision, cessation of follow-up questioning, unmodified output submission, and cohort-level deference curves."
  },
  {
    title: "Longitudinal agency erosion measurement",
    label: "Project idea 02",
    text:
      "Track task initiation rate, independent completion rate, and repeated decision delegation across high-reliance cohorts without depending on self-report."
  },
  {
    title: "Societal impact signal handoff",
    label: "Project idea 03",
    text:
      "Route deference curves, differential harm signals, and misuse-pattern detections into decision-ready formats for deployment and evaluation teams."
  }
];
